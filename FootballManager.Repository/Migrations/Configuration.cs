...
namespace FootballManager.Repository.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<FootballManager.Data.FootballContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            AutomaticMigrationDataLossAllowed = true;
            ContextKey = "FootballManager.Data.FootballContext";
        }

        protected override void Seed(FootballManager.Data.FootballContext context)
        {
            ...
            //    new Nation { NationId = 9, NationName = "France", Continent = Continent.Europe }
            //);
